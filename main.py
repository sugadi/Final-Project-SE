...
def game_Menu():
    ...
    while running:
        ...
        screen.fill((0, 0, 0))
        screen.blit(menuPicture, (0, 0))
        draw_text('Press ESC "Menu"', font, (255, 255, 255), screen, 20, 20)
        draw_text('Please Select Game Mode', font, (255, 255, 255), screen, 20, 50)
...
def k2_game():
    ...
    while running:
        ...
        # draw button
        pygame.draw.rect(screen, (0, 0, 128), button_1)
        draw_text('simple', font, (255, 255, 255), screen, 220, 100)
        pygame.draw.rect(screen, (0, 0, 128), button_2)
        draw_text('moderate', font, (255, 255, 255), screen, 220, 200)
        pygame.draw.rect(screen, (0, 0, 128), button_3)
        draw_text('complex', font, (255, 255, 255), screen, 220, 300)
        pygame.draw.rect(screen, (0, 0, 128), button_4)
        draw_text('complicate', font, (255, 255, 255), screen, 220, 400)
...
def options():
    ...
    while running:
        ...
        pygame.draw.rect(screen, (0, 0, 128), button_2)
        draw_text('Volume moderate', font, (255, 255, 255), screen, 180, 200)
        pygame.draw.rect(screen, (0, 0, 128), button_3)
    ...
    while True:
        ...
        if button_4.collidepoint((mx, my)):
            if click:
                ...
                stimulation_cusblueizedMap_MultiPlayerGameMenu()
        pygame.draw.rect(screen, (0, 0, 128), button_1)
        ...
        pygame.draw.rect(screen, (0, 0, 128), button_4)
        draw_text('Cusblueize Map', font, (255, 255, 255), screen, 170, 400)
...
def random_movement_player1(player_one_Container, width, height):
    """
...
def random_movement_player2(player_two_Container, width, height):
    """
...
def random_movement_player3(player_three_Container, width, height):
    """
...
def random_movement_player4(player_four_Container, width, height):
    """
...
def random_stimulation_300():
    ...
    while not is_GameOver:
        ...
        if key_pressed:
            stepCounter += 1
        random_movement_player1(player_one_container, width, height)
        random_movement_player2(player_two_container, width, height)
        displayGameWindow(gameWindow,
                          player_one_container=player_one_container,
                          forrestImage=forrestImage,
                          player_two_container=player_two_container,
...
def random_stimulation_300_3player():
    ...
    while not is_GameOver:
        ...
        random_movement_player1(player_one_container, width, height)
        random_movement_player2(player_two_container, width, height)
        random_movement_player3(player_three_container, width, height)
        displayGameWindow_player3(gameWindow,
                                  forrestImage=forrestImage,
                                  player_one_container=player_one_container,
                                  player_two_container=player_two_container,
...
def random_stimulation_300_4player():
    ...
    while not is_GameOver:
        ...
        random_movement_player2(player_two_container, width, height)
        random_movement_player3(player_three_container, width, height)
        random_movement_player4(player_four_container, width, height)
        displayGameWindow_player4(gameWindow,
                                  forrestImage=forrestImage,
                                  player_one_container=player_one_container,
                                  player_two_container=player_two_container,
...
def stimulation_cusblueizedMap_MultiPlayerGameMenu():
    ...
    while running:
        ...
        if button_1.collidepoint((mx, my)):
            if gameClick:
                print("2 players")
                random_stimulation_CusblueizeMap()
        if button_2.collidepoint((mx, my)):
            if gameClick:
                print("3 players")
                random_stimulation_CusblueizeMap_3player()
        if button_3.collidepoint((mx, my)):
            if gameClick:
                print("4 players")
                random_stimulation_CusblueizeMap_4player()
...
def random_stimulation_CusblueizeMap():
    """
...
def random_stimulation_CusblueizeMap_3player():
    """
...
def random_stimulation_CusblueizeMap_4player():
    """
